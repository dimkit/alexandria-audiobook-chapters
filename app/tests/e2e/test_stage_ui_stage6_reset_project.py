                    ...
                    with _IsolatedServer(config_patch=config_patch, env_overrides=env_overrides) as app_server:
                        with sync_playwright() as playwright:
                            ...
                            try:
                                ...
                                saved_projects_text = ""
                                try:
                                    saved_projects_text = page.locator("#saved-scripts-list").inner_text(timeout=2000)
                                except Exception:
                                    saved_projects_text = ""
                                archive_listing = []
                                ...
                                raise AssertionError(
                                    ...
                                    f"Audio logs tail:\n{audio_logs[-2000:]}\n"
                                    f"Saved projects list:\n{saved_projects_text[-2000:]}\n"
                                    f"Project archive dir listing:\n{json.dumps(archive_listing, ensure_ascii=False, indent=2)}\n"
