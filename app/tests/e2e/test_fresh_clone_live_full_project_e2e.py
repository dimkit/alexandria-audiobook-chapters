...
LIVE_FRESH_CLONE_LOCK_PATH = os.path.join(
    tempfile.gettempdir(),
    "threadspeak_fresh_clone_live_full_project.lock",
)
LIVE_PARTIAL_POINTER_PATH = os.path.join(
    tempfile.gettempdir(),
    "threadspeak_fresh_clone_live_partial_state.json",
)
LIVE_OUTPUT_DIR = os.path.join(
    tempfile.gettempdir(),
    "threadspeak_fresh_clone_live_outputs",
)
LIVE_PARTIAL_CHECKPOINT_BASENAME = "fresh_clone_live_checkpoint.json"
